...
/* ────────────────────────────────────────────────────────────────────────── */
/*  CameraRig — chains Section 1 + Section 2 camera movement               */
/* ────────────────────────────────────────────────────────────────────────── */
function CameraRig() {
  const { camera } = useThree();
  ...
  useFrame(() => {
    ...
    if (hp < 1) {
      ...
      camera.position.z = THREE.MathUtils.lerp(CAMERA_START_Z, CAMERA_LOGO_END_Z, hp);
    } else {
      // Section 2: fly through nebula
      camera.position.z = THREE.MathUtils.lerp(CAMERA_LOGO_END_Z, CAMERA_NEBULA_END_Z, np);
    }
  });
...
function SceneContent() {
  ...
  return (
    <>
      ...
      {/* Fog for depth */}
      <fog attach="fog" args={["#05000a", 30, 80]} />

      {/* Camera rig — handles both Section 1 + Section 2 */}
      <CameraRig />
