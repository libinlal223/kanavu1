...
function StarfieldBackground() {
  ...
  return <div ref={mountRef} className="absolute top-0 left-0 w-full h-full z-0" style={{ background: 'transparent' }} />
}
...
export default function StellarCardGallerySingle() {
  return (
    <CardProvider>
      <div className="w-full h-screen relative overflow-hidden" style={{ background: 'transparent' }}>
        <StarfieldBackground />
        ...
        <div className="absolute top-4 left-4 z-20 text-white pointer-events-none">
          <h2 className="text-2xl font-bold mb-2">Our Templates</h2>
